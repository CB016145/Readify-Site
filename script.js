...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const calcBtn = document.querySelector("button[onclick='calculateProgress()']");
    if(calcBtn) {
        calcBtn.addEventListener("click", calculateProgress);
    }
...
function validateForm(e) {
    ...
    let valid = true;
    if(!name) { document.getElementById("errorName").style.display = "block"; valid = false; }
    if(!email.includes("@")) { document.getElementById("errorEmail").style.display = "block"; valid = false; }
    if(!msg) { document.getElementById("errorMsg").style.display = "block"; valid = false; }
    ...
    if(valid) {
        ...
        if(successMsg) {
            ...
            successMsg.innerText = "Thank you! Your feedback has been sent.";
        }
